...
export const api = {
  ...
  createSentence: (versionId: string, body: { text: string; translation?: string; notes?: string }) =>
    apiFetch<Sentence>(`/versions/${versionId}/sentences`, { method: "POST", body: JSON.stringify(body) }),
  updateSentence: (id: string, body: { text?: string; translation?: string; notes?: string }) =>
