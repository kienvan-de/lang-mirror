 ...
 *
 * Used by src/worker/db/migrations.ts (CF Worker, via D1Adapter).
 * The wrangler migration system (migrations/0001_initial_schema.sql)
 * is the authoritative DDL runner for CF deployments.
 */
